...
DatosT1 <-
  ...
  mutate(missVal = (is.na(Temp))) #En missVal nos aparece que existe 1 solo NA
DatosT1
```
...
plot(Grafico)
```
#FALTA PONER LA DESCRIPCION DE LOS VALORES ATIPICOS
...
DatosT3 <-
  ...
  mutate(missVal5_10 = is.na(Tmonth)) #Nos aparece que existe 4 solo NA's
...
plot(Graf3)
```
*Descripción: El gráfico representa un diagrama de caja en el que se encuentra la cantidad de temperatura promedio mensual desde 1980 hasta 2013...* 
